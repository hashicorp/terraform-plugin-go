...
type ActionSchema struct {
	...
	// Block is the top level configuration block for this schema.
	Block *Schema_Block `protobuf:"bytes,2,opt,name=block,proto3" json:"block,omitempty"`
	// LinkedResources is a list of resources that are linked to this action.
...
const file_tfplugin6_proto_rawDesc = "" +
	...
	"\ridentity_data\x18\x01 \x01(\v2\x17.tfplugin6.DynamicValueR\fidentityData\"\x88\x02\n" +
	"\fActionSchema\x12\x18\n" +
	"\aversion\x18\x01 \x01(\x03R\aversion\x12-\n" +
	"\x05block\x18\x02 \x01(\v2\x17.tfplugin6.Schema.BlockR\x05block\x12Q\n" +
	"\x10linked_resources\x18\x03 \x03(\v2&.tfplugin6.ActionSchema.LinkedResourceR\x0flinkedResources\x1a\\\n" +
	"\x0eLinkedResource\x126\n" +
	"\tattribute\x18\x01 \x01(\v2\x18.tfplugin6.AttributePathR\tattribute\x12\x12\n" +
	"\x04type\x18\x02 \x01(\tR\x04type\"\x8e\x05\n" +
	"\bFunction\x12=\n" +
	"\n" +
	...
	"\ttype_name\x18\x01 \x01(\tR\btypeName\"\xe7\t\n" +
	...
	"\x1aephemeral_resource_schemas\x18\b \x03(\v2C.tfplugin6.GetProviderSchema.Response.EphemeralResourceSchemasEntryR\x18ephemeralResourceSchemas\x12_\n" +
	"\x0eaction_schemas\x18\t \x03(\v28.tfplugin6.GetProviderSchema.Response.ActionSchemasEntryR\ractionSchemas\x1aU\n" +
	...
	"\bdeferred\x18\x03 \x01(\v2\x13.tfplugin6.DeferredR\bdeferred\"\xfb\x04\n" +
	"\x11MoveResourceState\x1a\xf2\x02\n" +
	"\aRequest\x126\n" +
	...
	"\x0esource_private\x18\x06 \x01(\fR\rsourcePrivate\x12H\n" +
	"\x0fsource_identity\x18\a \x01(\v2\x1f.tfplugin6.ResourceIdentityDataR\x0esourceIdentity\x1a\xf0\x01\n" +
	"\bResponse\x12:\n" +
	...
	"\x05value\x18\x02 \x01(\v2!.tfplugin6.ResourceIdentitySchemaR\x05value:\x028\x01\"\x92\x02\n" +
	"\x17UpgradeResourceIdentity\x1ac\n" +
	"\aRequest\x12\x1b\n" +
	"\ttype_name\x18\x01 \x01(\tR\btypeName\x12\x18\n" +
	"\aversion\x18\x02 \x01(\x03R\aversion\x12!\n" +
	"\fraw_identity\x18\x03 \x01(\fR\vrawIdentity\x1a\x91\x01\n" +
	"\bResponse\x12L\n" +
	"\x11upgraded_identity\x18\x01 \x01(\v2\x1f.tfplugin6.ResourceIdentityDataR\x10upgradedIdentity\x127\n" +
	"\vdiagnostics\x18\x02 \x03(\v2\x15.tfplugin6.DiagnosticR\vdiagnostics\"\xe2\x01\n" +
	"\n" +
	"PlanAction\x1aW\n" +
	"\aRequest\x12\x1b\n" +
	"\ttype_name\x18\x01 \x01(\tR\btypeName\x12/\n" +
	"\x06config\x18\x02 \x01(\v2\x17.tfplugin6.DynamicValueR\x06config\x1a{\n" +
	"\bResponse\x127\n" +
	...
	"\fCancelAction\x1an\n" +
	"\aRequest\x12+\n" +
	"\x11cancelation_token\x18\x01 \x01(\tR\x10cancelationToken\x126\n" +
	"\x04type\x18\x02 \x01(\x0e2\".tfplugin6.CancelAction.CancelTypeR\x04type\x1aC\n" +
	"\bResponse\x127\n" +
	...
	"\fCancelAction\x12\x1f.tfplugin6.CancelAction.Request\x1a .tfplugin6.CancelAction.Response\x12Q\n" +
...
var file_tfplugin6_proto_goTypes = []any{
	...
	(*GetProviderSchema_Request)(nil),                // 62: tfplugin6.GetProviderSchema.Request
	(*GetProviderSchema_Response)(nil),               // 63: tfplugin6.GetProviderSchema.Response
	nil,                                              // 64: tfplugin6.GetProviderSchema.Response.ResourceSchemasEntry
	nil,                                              // 65: tfplugin6.GetProviderSchema.Response.DataSourceSchemasEntry
	nil,                                              // 66: tfplugin6.GetProviderSchema.Response.FunctionsEntry
	nil,                                              // 67: tfplugin6.GetProviderSchema.Response.EphemeralResourceSchemasEntry
	nil,                                              // 68: tfplugin6.GetProviderSchema.Response.ActionSchemasEntry
	...
	(*PlanAction_Request)(nil),               // 110: tfplugin6.PlanAction.Request
	(*PlanAction_Response)(nil),              // 111: tfplugin6.PlanAction.Response
	(*InvokeAction_Request)(nil),             // 112: tfplugin6.InvokeAction.Request
...
var file_tfplugin6_proto_depIdxs = []int32{
	...
	53,  // 8: tfplugin6.ActionSchema.linked_resources:type_name -> tfplugin6.ActionSchema.LinkedResource
	54,  // 9: tfplugin6.Function.parameters:type_name -> tfplugin6.Function.Parameter
	54,  // 10: tfplugin6.Function.variadic_parameter:type_name -> tfplugin6.Function.Parameter
	55,  // 11: tfplugin6.Function.return:type_name -> tfplugin6.Function.Return
	...
	9,   // 23: tfplugin6.ActionSchema.LinkedResource.attribute:type_name -> tfplugin6.AttributePath
	...
	59,  // 27: tfplugin6.GetMetadata.Response.data_sources:type_name -> tfplugin6.GetMetadata.DataSourceMetadata
	60,  // 28: tfplugin6.GetMetadata.Response.resources:type_name -> tfplugin6.GetMetadata.ResourceMetadata
	58,  // 29: tfplugin6.GetMetadata.Response.functions:type_name -> tfplugin6.GetMetadata.FunctionMetadata
	61,  // 30: tfplugin6.GetMetadata.Response.ephemeral_resources:type_name -> tfplugin6.GetMetadata.EphemeralResourceMetadata
	12,  // 31: tfplugin6.GetProviderSchema.Response.provider:type_name -> tfplugin6.Schema
	64,  // 32: tfplugin6.GetProviderSchema.Response.resource_schemas:type_name -> tfplugin6.GetProviderSchema.Response.ResourceSchemasEntry
	65,  // 33: tfplugin6.GetProviderSchema.Response.data_source_schemas:type_name -> tfplugin6.GetProviderSchema.Response.DataSourceSchemasEntry
	...
	66,  // 37: tfplugin6.GetProviderSchema.Response.functions:type_name -> tfplugin6.GetProviderSchema.Response.FunctionsEntry
	67,  // 38: tfplugin6.GetProviderSchema.Response.ephemeral_resource_schemas:type_name -> tfplugin6.GetProviderSchema.Response.EphemeralResourceSchemasEntry
	68,  // 39: tfplugin6.GetProviderSchema.Response.action_schemas:type_name -> tfplugin6.GetProviderSchema.Response.ActionSchemasEntry
	...
	6,   // 127: tfplugin6.PlanAction.Response.new_config:type_name -> tfplugin6.DynamicValue
