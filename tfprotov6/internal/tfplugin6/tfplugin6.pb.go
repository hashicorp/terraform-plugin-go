...
type CancelAction_CancelType int32

const (
	CancelAction_SOFT CancelAction_CancelType = 0
	CancelAction_HARD CancelAction_CancelType = 1
)

// Enum value maps for CancelAction_CancelType.
var (
	CancelAction_CancelType_name = map[int32]string{
		0: "SOFT",
		1: "HARD",
	}
	CancelAction_CancelType_value = map[string]int32{
		"SOFT": 0,
		"HARD": 1,
	}
)

func (x CancelAction_CancelType) Enum() *CancelAction_CancelType {
	p := new(CancelAction_CancelType)
	*p = x
	return p
}

func (x CancelAction_CancelType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (CancelAction_CancelType) Descriptor() protoreflect.EnumDescriptor {
	return file_tfplugin6_proto_enumTypes[5].Descriptor()
}

func (CancelAction_CancelType) Type() protoreflect.EnumType {
	return &file_tfplugin6_proto_enumTypes[5]
}

func (x CancelAction_CancelType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use CancelAction_CancelType.Descriptor instead.
func (CancelAction_CancelType) EnumDescriptor() ([]byte, []int) {
...
type ActionSchema struct {
	...
	// Block is the top level configuration block for this schema.
	Block *Schema_Block `protobuf:"bytes,2,opt,name=block,proto3" json:"block,omitempty"`
	// LinkedResources is a map of stringified cty.Paths (to the attribute in the config)
	// to the linked resource schema.
	LinkedResources map[string]*ActionSchema_LinkedResource `protobuf:"bytes,3,rep,name=linked_resources,json=linkedResources,proto3" json:"linked_resources,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *ActionSchema) GetLinkedResources() map[string]*ActionSchema_LinkedResource {
	if x != nil {
...
// TODO: We will need a way to express lists / maps of resources / possibly multiple different resource types
...
type PlanAction_Response struct {
	state       protoimpl.MessageState `protogen:"open.v1"`
	Diagnostics []*Diagnostic          `protobuf:"bytes,1,rep,name=diagnostics,proto3" json:"diagnostics,omitempty"`
	// An action might know that it will change a resource that has been passed in.
	...
	PlannedResourceChanges map[string]*DynamicValue `protobuf:"bytes,2,rep,name=planned_resource_changes,json=plannedResourceChanges,proto3" json:"planned_resource_changes,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
}
...
func (x *PlanAction_Response) GetPlannedResourceChanges() map[string]*DynamicValue {
	if x != nil {
		return x.PlannedResourceChanges
	}
	return nil
}
...
// Sent when the action has started (to give us feedback and a way to cancel it).
...
func (*InvokeAction_Event_Started) Descriptor() ([]byte, []int) {
	return file_tfplugin6_proto_rawDescGZIP(), []int{36, 1, 0}
}

func (x *InvokeAction_Event_Started) GetCancelationToken() string {
	if x != nil {
		return x.CancelationToken
	}
	return ""
}
...
func (*InvokeAction_Event_Finished) Descriptor() ([]byte, []int) {
	return file_tfplugin6_proto_rawDescGZIP(), []int{36, 1, 1}
}

func (x *InvokeAction_Event_Finished) GetOutputs() map[string]*DynamicValue {
	if x != nil {
		return x.Outputs
	}
	return nil
...
func (x *InvokeAction_Event_Cancelled) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
type CancelAction_Request struct {
	state            protoimpl.MessageState  `protogen:"open.v1"`
	CancelationToken string                  `protobuf:"bytes,1,opt,name=cancelation_token,json=cancelationToken,proto3" json:"cancelation_token,omitempty"`
	Type             CancelAction_CancelType `protobuf:"varint,2,opt,name=type,proto3,enum=tfplugin6.CancelAction_CancelType" json:"type,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *CancelAction_Request) GetCancelationToken() string {
	if x != nil {
		return x.CancelationToken
	}
	return ""
...
func (x *CancelAction_Request) GetType() CancelAction_CancelType {
	if x != nil {
		return x.Type
	}
	return CancelAction_SOFT
}
...
var file_tfplugin6_proto_rawDesc = string([]byte{
	...
	0x64, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x44, 0x61, 0x74, 0x61, 0x22, 0xc2, 0x02, 0x0a, 0x0c,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x6f, 0x6e, 0x73, 0x12, 0x61, 0x0a, 0x13, 0x65, 0x70, 0x68, 0x65, 0x6d, 0x65, 0x72, 0x61, 0x6c,
	0x5f, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x18, 0x06, 0x20, 0x03, 0x28, 0x0b,
	0x32, 0x30, 0x2e, 0x74, 0x66, 0x70, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x36, 0x2e, 0x47, 0x65, 0x74,
	0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x2e, 0x45, 0x70, 0x68, 0x65, 0x6d, 0x65, 0x72,
	0x61, 0x6c, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61,
	0x74, 0x61, 0x52, 0x12, 0x65, 0x70, 0x68, 0x65, 0x6d, 0x65, 0x72, 0x61, 0x6c, 0x52, 0x65, 0x73,
	0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x1a, 0x26, 0x0a, 0x10, 0x46, 0x75, 0x6e, 0x63, 0x74, 0x69,
	...
	0x6d, 0x65, 0x1a, 0x38, 0x0a, 0x19, 0x45, 0x70, 0x68, 0x65, 0x6d, 0x65, 0x72, 0x61, 0x6c, 0x52,
	...
	0x28, 0x09, 0x52, 0x08, 0x74, 0x79, 0x70, 0x65, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0xe7, 0x09, 0x0a,
	0x11, 0x47, 0x65, 0x74, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x53, 0x63, 0x68, 0x65,
	0x6d, 0x61, 0x1a, 0x09, 0x0a, 0x07, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0xc6, 0x09,
	...
	0x03, 0x28, 0x0b, 0x32, 0x3a, 0x2e, 0x74, 0x66, 0x70, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x36, 0x2e,
	...
	0x28, 0x0b, 0x32, 0x34, 0x2e, 0x74, 0x66, 0x70, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x36, 0x2e, 0x47,
	...
	0x53, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x73, 0x12, 0x5f, 0x0a, 0x0e, 0x61, 0x63, 0x74, 0x69, 0x6f,
	0x6e, 0x5f, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x73, 0x18, 0x09, 0x20, 0x03, 0x28, 0x0b, 0x32,
	0x38, 0x2e, 0x74, 0x66, 0x70, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x36, 0x2e, 0x47, 0x65, 0x74, 0x50,
	0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x53, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x2e, 0x52, 0x65,
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x2e, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0
	(*PlanAction)(nil),                               // 41: tfplugin6.PlanAction
	(*InvokeAction)(nil),                             // 42: tfplugin6.InvokeAction
	(*CancelAction)(nil),                             // 43: tfplugin6.CancelAction
	...
	(*ActionSchema_LinkedResource)(nil),              // 53: tfplugin6.ActionSchema.LinkedResource
	nil,                                              // 54: tfplugin6.ActionSchema.LinkedResourcesEntry
	...
	(*GetProviderSchema_Request)(nil),                // 63: tfplugin6.GetProviderSchema.Request
	(*GetProviderSchema_Response)(nil),               // 64: tfplugin6.GetProviderSchema.Response
	nil,                                              // 65: tfplugin6.GetProviderSchema.Response.ResourceSchemasEntry
	nil,                                              // 66: tfplugin6.GetProviderSchema.Response.DataSourceSchemasEntry
	nil,                                              // 67: tfplugin6.GetProviderSchema.Response.FunctionsEntry
	nil,                                              // 68: tfplugin6.GetProviderSchema.Response.EphemeralResourceSchemasEntry
	nil,                                              // 69: tfplugin6.GetProviderSchema.Response.ActionSchemasEntry
	(*ValidateProviderConfig_Request)(nil),           // 70: tfplugin6.ValidateProviderConfig.Request
	(*ValidateProviderConfig_Response)(nil),          // 71: tfplugin6.ValidateProviderConfig.Response
	(*UpgradeResourceState_Request)(nil),             // 72: tfplugin6.UpgradeResourceState.Request
	(*UpgradeResourceState_Response)(nil),            // 73: tfplugin6.UpgradeResourceState.Response
	(*ValidateResourceConfig_Request)(nil),           // 74: tfplugin6.ValidateResourceConfig.Request
	(*ValidateResourceConfig_Response)(nil),          // 75: tfplugin6.ValidateResourceConfig.Response
	(*ValidateDataResourceConfig_Request)(nil),       // 76: tfplugin6.ValidateDataResourceConfig.Request
	(*ValidateDataResourceConfig_Response)(nil),      // 77: tfplugin6.ValidateDataResourceConfig.Response
	(*ConfigureProvider_Request)(nil),                // 78: tfplugin6.ConfigureProvider.Request
	(*ConfigureProvider_Response)(nil),               // 79: tfplugin6.ConfigureProvider.Response
	(*ReadResource_Request)(nil),                     // 80: tfplugin6.ReadResource.Request
	(*ReadResource_Response)(nil),                    // 81: tfplugin6.ReadResource.Response
	(*PlanResourceChange_Request)(nil),               // 82: tfplugin6.PlanResourceChange.Request
	(*PlanResourceChange_Response)(nil),              // 83: tfplugin6.PlanResourceChange.Response
	(*ApplyResourceChange_Request)(nil),              // 84: tfplugin6.ApplyResourceChange.Request
	(*ApplyResourceChange_Response)(nil),             // 85: tfplugin6.ApplyResourceChange.Response
	(*ImportResourceState_Request)(nil),              // 86: tfplugin6.ImportResourceState.Request
	(*ImportResourceState_ImportedResource)(nil),     // 87: tfplugin6.ImportResourceState.ImportedResource
	(*ImportResourceState_Response)(nil),             // 88: tfplugin6.ImportResourceState.Response
	(*MoveResourceState_Request)(nil),                // 89: tfplugin6.MoveResourceState.Request
	(*MoveResourceState_Response)(nil),               // 90: tfplugin6.MoveResourceState.Response
	(*ReadDataSource_Request)(nil),                   // 91: tfplugin6.ReadDataSource.Request
	(*ReadDataSource_Response)(nil),                  // 92: tfplugin6.ReadDataSource.Response
	(*GetFunctions_Request)(nil),                     // 93: tfplugin6.GetFunctions.Request
	(*GetFunctions_Response)(nil),                    // 94: tfplugin6.GetFunctions.Response
	nil,                                              // 95: tfplugin6.GetFunctions.Response.FunctionsEntry
	(*CallFunction_Request)(nil),                     // 96: tfplugin6.CallFunction.Request
	(*CallFunction_Response)(nil),                    // 97: tfplugin6.CallFunction.Response
	(*ValidateEphemeralResourceConfig_Request)(nil),  // 98: tfplugin6.ValidateEphemeralResourceConfig.Request
	(*ValidateEphemeralResourceConfig_Response)(nil), // 99: tfplugin6.ValidateEphemeralResourceConfig.Response
	(*OpenEphemeralResource_Request)(nil),            // 100: tfplugin6.OpenEphemeralResource.Request
	(*OpenEphemeralResource_Response)(nil),           // 101: tfplugin6.OpenEphemeralResource.Response
	(*RenewEphemeralResource_Request)(nil),           // 102: tfplugin6.RenewEphemeralResource.Request
	(*RenewEphemeralResource_Response)(nil),          // 103: tfplugin6.RenewEphemeralResource.Response
	(*CloseEphemeralResource_Request)(nil),           // 104: tfplugin6.CloseEphemeralResource.Request
	(*CloseEphemeralResource_Response)(nil),          // 105: tfplugin6.CloseEphemeralResource.Response
	(*GetResourceIdentitySchemas_Request)(nil),       // 106: tfplugin6.GetResourceIdentitySchemas.Request
	(*GetResourceIdentitySchemas_Response)(nil),      // 107: tfplugin6.GetResourceIdentitySchemas.Response
	nil,                                      // 108: tfplugin6.GetResourceIdentitySchemas.Response.IdentitySchemasEntry
	(*UpgradeResourceIdentity_Request)(nil),  // 109: tfplugin6.UpgradeResourceIdentity.Request
	(*UpgradeResourceIdentity_Response)(nil), // 110: tfplugin6.UpgradeResourceIdentity.Response
	(*PlanAction_Request)(nil),               // 111: tfplugin6.PlanAction.Request
	(*PlanAction_Response)(nil),              // 112: tfplugin6.PlanAction.Response
	nil,                                      // 113: tfplugin6.PlanAction.Response.PlannedResourceChangesEntry
	(*InvokeAction_Request)(nil),             // 114: tfplugin6.InvokeAction.Request
	(*InvokeAction_Event)(nil),               // 115: tfplugin6.InvokeAction.Event
	(*InvokeAction_Event_Started)(nil),       // 116: tfplugin6.InvokeAction.Event.Started
	(*InvokeAction_Event_Finished)(nil),      // 117: tfplugin6.InvokeAction.Event.Finished
	(*InvokeAction_Event_Diagnostics)(nil),   // 118: tfplugin6.InvokeAction.Event.Diagnostics
	(*InvokeAction_Event_Cancelled)(nil),     // 119: tfplugin6.InvokeAction.Event.Cancelled
	(*InvokeAction_Event_Progress)(nil),      // 120: tfplugin6.InvokeAction.Event.Progress
	nil,                                      // 121: tfplugin6.InvokeAction.Event.Finished.OutputsEntry
	nil,                                      // 122: tfplugin6.InvokeAction.Event.Finished.ResourceChangesEntry
	(*CancelAction_Request)(nil),             // 123: tfplugin6.CancelAction.Request
	(*CancelAction_Response)(nil),            // 124: tfplugin6.CancelAction.Response
...
var file_tfplugin6_proto_depIdxs = []int32{
	...
	44,  // 2: tfplugin6.AttributePath.steps:type_name -> tfplugin6.AttributePath.Step
	47,  // 3: tfplugin6.RawState.flatmap:type_name -> tfplugin6.RawState.FlatmapEntry
	48,  // 4: tfplugin6.Schema.block:type_name -> tfplugin6.Schema.Block
	52,  // 5: tfplugin6.ResourceIdentitySchema.identity_attributes:type_name -> tfplugin6.ResourceIdentitySchema.IdentityAttribute
	6,   // 6: tfplugin6.ResourceIdentityData.identity_data:type_name -> tfplugin6.DynamicValue
	48,  // 7: tfplugin6.ActionSchema.block:type_name -> tfplugin6.Schema.Block
	54,  // 8: tfplugin6.ActionSchema.linked_resources:type_name -> tfplugin6.ActionSchema.LinkedResourcesEntry
	55,  // 9: tfplugin6.Function.parameters:type_name -> tfplugin6.Function.Parameter
	55,  // 10: tfplugin6.Function.variadic_parameter:type_name -> tfplugin6.Function.Parameter
	56,  // 11: tfplugin6.Function.return:type_name -> tfplugin6.Function.Return
	...
	49,  // 14: tfplugin6.Schema.Block.attributes:type_name -> tfplugin6.Schema.Attribute
	50,  // 15: tfplugin6.Schema.Block.block_types:type_name -> tfplugin6.Schema.NestedBlock
	0,   // 16: tfplugin6.Schema.Block.description_kind:type_name -> tfplugin6.StringKind
	51,  // 17: tfplugin6.Schema.Attribute.nested_type:type_name -> tfplugin6.Schema.Object
	0,   // 18: tfplugin6.Schema.Attribute.description_kind:type_name -> tfplugin6.StringKind
	48,  // 19: tfplugin6.Schema.NestedBlock.block:type_name -> tfplugin6.Schema.Block
	2,   // 20: tfplugin6.Schema.NestedBlock.nesting:type_name -> tfplugin6.Schema.NestedBlock.NestingMode
	49,  // 21: tfplugin6.Schema.Object.attributes:type_name -> tfplugin6.Schema.Attribute
	3,   // 22: tfplugin6.Schema.Object.nesting:type_name -> tfplugin6.Schema.Object.NestingMode
	53,  // 23: tfplugin6.ActionSchema.LinkedResourcesEntry.value:type_name -> tfplugin6.ActionSchema.LinkedResource
	0,   // 24: tfplugin6.Function.Parameter.description_kind:type_name -> tfplugin6.StringKind
	17,  // 25: tfplugin6.GetMetadata.Response.server_capabilities:type_name -> tfplugin6.ServerCapabilities
	7,   // 26: tfplugin6.GetMetadata.Response.diagnostics:type_name -> tfplugin6.Diagnostic
	60,  // 27: tfplugin6.GetMetadata.Response.data_sources:type_name -> tfplugin6.GetMetadata.DataSourceMetadata
	61,  // 28: tfplugin6.GetMetadata.Response.resources:type_name -> tfplugin6.GetMetadata.ResourceMetadata
	59,  // 29: tfplugin6.GetMetadata.Response.functions:type_name -> tfplugin6.GetMetadata.FunctionMetadata
	62,  // 30: tfplugin6.GetMetadata.Response.ephemeral_resources:type_name -> tfplugin6.GetMetadata.EphemeralResourceMetadata
	12,  // 31: tfplugin6.GetProviderSchema.Response.provider:type_name -> tfplugin6.Schema
	65,  // 32: tfplugin6.GetProviderSchema.Response.resource_schemas:type_name -> tfplugin6.GetProviderSchema.Response.ResourceSchemasEntry
	66,  // 33: tfplugin6.GetProviderSchema.Response.data_source_schemas:type_name -> tfplugin6.GetProviderSchema.Response.DataSourceSchemasEntry
	7,   // 34: tfplugin6.GetProviderSchema.Response.diagnostics:type_name -> tfplugin6.Diagnostic
	12,  // 35: tfplugin6.GetProviderSchema.Response.provider_meta:type_name -> tfplugin6.Schema
	17,  // 36: tfplugin6.GetProviderSchema.Response.server_capabilities:type_name -> tfplugin6.ServerCapabilities
	67,  // 37: tfplugin6.GetProviderSchema.Response.functions:type_name -> tfplugin6.GetProviderSchema.Response.FunctionsEntry
	68,  // 38: tfplugin6.GetProviderSchema.Response.ephemeral_resource_schemas:type_name -> tfplugin6.GetProviderSchema.Response.EphemeralResourceSchemasEntry
	69,  // 39: tfplugin6.GetProviderSchema.Response.action_schemas:type_name -> tfplugin6.GetProviderSchema.Response.ActionSchemasEntry
	12,  // 40: tfplugin6.GetProviderSchema.Response.ResourceSchemasEntry.value:type_name -> tfplugin6.Schema
	12,  // 41: tfplugin6.GetProviderSchema.Response.DataSourceSchemasEntry.value:type_name -> tfplugin6.Schema
	16,  // 42: tfplugin6.GetProviderSchema.Response.FunctionsEntry.value:type_name -> tfplugin6.Function
	12,  // 43: tfplugin6.GetProviderSchema.Response.EphemeralResourceSchemasEntry.value:type_name -> tfplugin6.Schema
	15,  // 44: tfplugin6.GetProviderSchema.Response.ActionSchemasEntry.value:type_name -> tfplugin6.ActionSchema
	6,   // 45: tfplugin6.ValidateProviderConfig.Request.config:type_name -> tfplugin6.DynamicValue
	7,   // 46: tfplugin6.ValidateProviderConfig.Response.diagnostics:type_name -> tfplugin6.Diagnostic
	11,  // 47: tfplugin6.UpgradeResourceState.Request.raw_state:type_name -> tfplugin6.RawState
	6,   // 48: tfplugin6.UpgradeResourceState.Response.upgraded_state:type_name -> tfplugin6.DynamicValue
	7,   // 49: tfplugin6.UpgradeResourceState.Response.diagnostics:type_name -> tfplugin6.Diagnostic
	6,   // 50: tfplugin6.ValidateResourceConfig.Request.config:type_name -> tfplugin6.DynamicValue
	18,  // 51: tfplugin6.ValidateResourceConfig.Request.client_capabilities:type_name -> tfplugin6.ClientCapabilities
	7,   // 52: tfplugin6.ValidateResourceConfig.Response.diagnostics:type_name -> tfplugin6.Diagnostic
	6,   // 53: tfplugin6.ValidateDataResourceConfig.Request.config:type_name -> tfplugin6.DynamicValue
	7,   // 54: tfplugin6.ValidateDataResourceConfig.Response.diagnostics:type_name -> tfplugin6.Diagnostic
	6,   // 55: tfplugin6.ConfigureProvider.Request.config:type_name -> tfplugin6.DynamicValue
	18,  // 56: tfplugin6.ConfigureProvider.Request.client_capabilities:type_name -> tfplugin6.ClientCapabilities
	7,   // 57: tfplugin6.ConfigureProvider.Response.diagnostics:type_name -> tfplugin6.Diagnostic
	6,   // 58: tfplugin6.ReadResource.Request.current_state:type_name -> tfplugin6.DynamicValue
	6,   // 59: tfplugin6.ReadResource.Request.provider_meta:type_name -> tfplugin6.DynamicValue
	18,  // 60: tfplugin6.ReadResource.Request.client_capabilities:type_name -> tfplugin6.ClientCapabilities
	14,  // 61: tfplugin6.ReadResource.Request.current_identity:type_name -> tfplugin6.ResourceIdentityData
	6,   // 62: tfplugin6.ReadResource.Response.new_state:type_name -> tfplugin6.DynamicValue
	7,   // 63: tfplugin6.ReadResource.Response.diagnostics:type_name -> tfplugin6.Diagnostic
	19,  // 64: tfplugin6.ReadResource.Response.deferred:type_name -> tfplugin6.Deferred
	14,  // 65: tfplugin6.ReadResource.Response.new_identity:type_name -> tfplugin6.ResourceIdentityData
	6,   // 66: tfplugin6.PlanResourceChange.Request.prior_state:type_name -> tfplugin6.DynamicValue
	6,   // 67: tfplugin6.PlanResourceChange.Request.proposed_new_state:type_name -> tfplugin6.DynamicValue
	6,   // 68: tfplugin6.PlanResourceChange.Request.config:type_name -> tfplugin6.DynamicValue
	6,   // 69: tfplugin6.PlanResourceChange.Request.provider_meta:type_name -> tfplugin6.DynamicValue
	18,  // 70: tfplugin6.PlanResourceChange.Request.client_capabilities:type_name -> tfplugin6.ClientCapabilities
	14,  // 71: tfplugin6.PlanResourceChange.Request.prior_identity:type_name -> tfplugin6.ResourceIdentityData
	6,   // 72: tfplugin6.PlanResourceChange.Response.planned_state:type_name -> tfplugin6.DynamicValue
	9,   // 73: tfplugin6.PlanResourceChange.Response.requires_replace:type_name -> tfplugin6.AttributePath
	7,   // 74: tfplugin6.PlanResourceChange.Response.diagnostics:type_name -> tfplugin6.Diagnostic
	19,  // 75: tfplugin6.PlanResourceChange.Response.deferred:type_name -> tfplugin6.Deferred
	14,  // 76: tfplugin6.PlanResourceChange.Response.planned_identity:type_name -> tfplugin6.ResourceIdentityData
	6,   // 77: tfplugin6.ApplyResourceChange.Request.prior_state:type_name -> tfplugin6.DynamicValue
	6,   // 78: tfplugin6.ApplyResourceChange.Request.planned_state:type_name -> tfplugin6.DynamicValue
	6,   // 79: tfplugin6.ApplyResourceChange.Request.config:type_name -> tfplugin6.DynamicValue
	6,   // 80: tfplugin6.ApplyResourceChange.Request.provider_meta:type_name -> tfplugin6.DynamicValue
	14,  // 81: tfplugin6.ApplyResourceChange.Request.planned_identity:type_name -> tfplugin6.ResourceIdentityData
	6,   // 82: tfplugin6.ApplyResourceChange.Response.new_state:type_name -> tfplugin6.DynamicValue
	7,   // 83: tfplugin6.ApplyResourceChange.Response.diagnostics:type_name -> tfplugin6.Diagnostic
	14,  // 84: tfplugin6.ApplyResourceChange.Response.new_identity:type_name -> tfplugin6.ResourceIdentityData
	18,  // 85: tfplugin6.ImportResourceState.Request.client_capabilities:type_name -> tfplugin6.ClientCapabilities
	14,  // 86: tfplugin6.ImportResourceState.Request.identity:type_name -> tfplugin6.ResourceIdentityData
	6,   // 87: tfplugin6.ImportResourceState.ImportedResource.state:type_name -> tfplugin6.DynamicValue
	14,  // 88: tfplugin6.ImportResourceState.ImportedResource.identity:type_name -> tfplugin6.ResourceIdentityData
	87,  // 89: tfplugin6.ImportResourceState.Response.imported_resources:type_name -> tfplugin6.ImportResourceState.ImportedResource
	7,   // 90: tfplugin6.ImportResourceState.Response.diagnostics:type_name -> tfplugin6.Diagnostic
	19,  // 91: tfplugin6.ImportResourceState.Response.deferred:type_name -> tfplugin6.Deferred
	11,  // 92: tfplugin6.MoveResourceState.Request.source_state:type_name -> tfplugin6.RawState
	14,  // 93: tfplugin6.MoveResourceState.Request.source_identity:type_name -> tfplugin6.ResourceIdentityData
	6,   // 94: tfplugin6.MoveResourceState.Response.target_state:type_name -> tfplugin6.DynamicValue
	7,   // 95: tfplugin6.MoveResourceState.Response.diagnostics:type_name -> tfplugin6.Diagnostic
	14,  // 96: tfplugin6.MoveResourceState.Response.target_identity:type_name -> tfplugin6.ResourceIdentityData
	6,   // 97: tfplugin6.ReadDataSource.Request.config:type_name -> tfplugin6.DynamicValue
	6,   // 98: tfplugin6.ReadDataSource.Request.provider_meta:type_name -> tfplugin6.DynamicValue
	18,  // 99: tfplugin6.ReadDataSource.Request.client_capabilities:type_name -> tfplugin6.ClientCapabilities
	6,   // 100: tfplugin6.ReadDataSource.Response.state:type_name -> tfplugin6.DynamicValue
	7,   // 101: tfplugin6.ReadDataSource.Response.diagnostics:type_name -> tfplugin6.Diagnostic
	19,  // 102: tfplugin6.ReadDataSource.Response.deferred:type_name -> tfplugin6.Deferred
	95,  // 103: tfplugin6.GetFunctions.Response.functions:type_name -> tfplugin6.GetFunctions.Response.FunctionsEntry
	7,   // 104: tfplugin6.GetFunctions.Response.diagnostics:type_name -> tfplugin6.Diagnostic
	16,  // 105: tfplugin6.GetFunctions.Response.FunctionsEntry.value:type_name -> tfplugin6.Function
	6,   // 106: tfplugin6.CallFunction.Request.arguments:type_name -> tfplugin6.DynamicValue
	6,   // 107: tfplugin6.CallFunction.Response.result:type_name -> tfplugin6.DynamicValue
	8,   // 108: tfplugin6.CallFunction.Response.error:type_name -> tfplugin6.FunctionError
	6,   // 109: tfplugin6.ValidateEphemeralResourceConfig.Request.config:type_name -> tfplugin6.DynamicValue
	7,   // 110: tfplugin6.ValidateEphemeralResourceConfig.Response.diagnostics:type_name -> tfplugin6.Diagnostic
	...
	125, // 114: tfplugin6.OpenEphemeralResource.Response.renew_at:type_name -> google.protobuf.Timestamp
	...
	125, // 118: tfplugin6.RenewEphemeralResource.Response.renew_at:type_name -> google.protobuf.Timestamp
	7,   // 119: tfplugin6.CloseEphemeralResource.Response.diagnostics:type_name -> tfplugin6.Diagnostic
	108, // 120: tfplugin6.GetResourceIdentitySchemas.Response.identity_schemas:type_name -> tfplugin6.GetResourceIdentitySchemas.Response.IdentitySchemasEntry
	7,   // 121: tfplugin6.GetResourceIdentitySchemas.Response.diagnostics:type_name -> tfplugin6.Diagnostic
	13,  // 122: tfplugin6.GetResourceIdentitySchemas.Response.IdentitySchemasEntry.value:type_name -> tfplugin6.ResourceIdentitySchema
	14,  // 123: tfplugin6.UpgradeResourceIdentity.Response.upgraded_identity:type_name -> tfplugin6.ResourceIdentityData
	7,   // 124: tfplugin6.UpgradeResourceIdentity.Response.diagnostics:type_name -> tfplugin6.Diagnostic
	6,   // 125: tfplugin6.PlanAction.Request.config:type_name -> tfplugin6.DynamicValue
	7,   // 126: tfplugin6.PlanAction.Response.diagnostics:type_name -> tfplugin6.Diagnostic
	113, // 127: tfplugin6.PlanAction.Response.planned_resource_changes:type_name -> tfplugin6.PlanAction.Response.PlannedResourceChangesEntry
	6,   // 128: tfplugin6.PlanAction.Response.PlannedResourceChangesEntry.value:type_name -> tfplugin6.DynamicValue
	6,   // 129: tfplugin6.InvokeAction.Request.config:type_name -> tfplugin6.DynamicValue
	116, // 130: tfplugin6.InvokeAction.Event.started:type_name -> tfplugin6.InvokeAction.Event.Started
	117, // 131: tfplugin6.InvokeAction.Event.finished:type_name -> tfplugin6.InvokeAction.Event.Finished
	118, // 132: tfplugin6.InvokeAction.Event.diagnostics:type_name -> tfplugin6.InvokeAction.Event.Diagnostics
	119, // 133: tfplugin6.InvokeAction.Event.cancelled:type_name -> tfplugin6.InvokeAction.Event.Cancelled
	120, // 134: tfplugin6.InvokeAction.Event.progress:type_name -> tfplugin6.InvokeAction.Event.Progress
	121, // 135: tfplugin6.InvokeAction.Event.Finished.outputs:type_name -> tfplugin6.InvokeAction.Event.Finished.OutputsEntry
	122, // 136: tfplugin6.InvokeAction.Event.Finished.resource_changes:type_name -> tfplugin6.InvokeAction.Event.Finished.ResourceChangesEntry
	7,   // 137: tfplugin6.InvokeAction.Event.Diagnostics.diagnostics:type_name -> tfplugin6.Diagnostic
	6,   // 138: tfplugin6.InvokeAction.Event.Finished.OutputsEntry.value:type_name -> tfplugin6.DynamicValue
	6,   // 139: tfplugin6.InvokeAction.Event.Finished.ResourceChangesEntry.value:type_name -> tfplugin6.DynamicValue
	...
	57,  // 142: tfplugin6.Provider.GetMetadata:input_type -> tfplugin6.GetMetadata.Request
	63,  // 143: tfplugin6.Provider.GetProviderSchema:input_type -> tfplugin6.GetProviderSchema.Request
	106, // 144: tfplugin6.Provider.GetResourceIdentitySchemas:input_type -> tfplugin6.GetResourceIdentitySchemas.Request
	70,  // 145: tfplugin6.Provider.ValidateProviderConfig:input_type -> tfplugin6.ValidateProviderConfig.Request
	74,  // 146: tfplugin6.Provider.ValidateResourceConfig:input_type -> tfplugin6.ValidateResourceConfig.Request
	76,  // 147: tfplugin6.Provider.ValidateDataResourceConfig:input_type -> tfplugin6.ValidateDataResourceConfig.Request
	72,  // 148: tfplugin6.Provider.UpgradeResourceState:input_type -> tfplugin6.UpgradeResourceState.Request
	109, // 149: tfplugin6.Provider.UpgradeResourceIdentity:input_type -> tfplugin6.UpgradeResourceIdentity.Request
	78,  // 150: tfplugin6.Provider.ConfigureProvider:input_type -> tfplugin6.ConfigureProvider.Request
	80,  // 151: tfplugin6.Provider.ReadResource:input_type -> tfplugin6.ReadResource.Request
	82,  // 152: tfplugin6.Provider.PlanResourceChange:input_type -> tfplugin6.PlanResourceChange.Request
	84,  // 153: tfplugin6.Provider.ApplyResourceChange:input_type -> tfplugin6.ApplyResourceChange.Request
	86,  // 154: tfplugin6.Provider.ImportResourceState:input_type -> tfplugin6.ImportResourceState.Request
	89,  // 155: tfplugin6.Provider.MoveResourceState:input_type -> tfplugin6.MoveResourceState.Request
	91,  // 156: tfplugin6.Provider.ReadDataSource:input_type -> tfplugin6.ReadDataSource.Request
	98,  // 157: tfplugin6.Provider.ValidateEphemeralResourceConfig:input_type -> tfplugin6.ValidateEphemeralResourceConfig.Request
	100, // 158: tfplugin6.Provider.OpenEphemeralResource:input_type -> tfplugin6.OpenEphemeralResource.Request
	102, // 159: tfplugin6.Provider.RenewEphemeralResource:input_type -> tfplugin6.RenewEphemeralResource.Request
	104, // 160: tfplugin6.Provider.CloseEphemeralResource:input_type -> tfplugin6.CloseEphemeralResource.Request
	93,  // 161: tfplugin6.Provider.GetFunctions:input_type -> tfplugin6.GetFunctions.Request
	96,  // 162: tfplugin6.Provider.CallFunction:input_type -> tfplugin6.CallFunction.Request
	111, // 163: tfplugin6.Provider.PlanAction:input_type -> tfplugin6.PlanAction.Request
	114, // 164: tfplugin6.Provider.InvokeAction:input_type -> tfplugin6.InvokeAction.Request
	123, // 165: tfplugin6.Provider.CancelAction:input_type -> tfplugin6.CancelAction.Request
	45,  // 166: tfplugin6.Provider.StopProvider:input_type -> tfplugin6.StopProvider.Request
	58,  // 167: tfplugin6.Provider.GetMetadata:output_type -> tfplugin6.GetMetadata.Response
	64,  // 168: tfplugin6.Provider.GetProviderSchema:output_type -> tfplugin6.GetProviderSchema.Response
	107, // 169: tfplugin6.Provider.GetResourceIdentitySchemas:output_type -> tfplugin6.GetResourceIdentitySchemas.Response
	71,  // 170: tfplugin6.Provider.ValidateProviderConfig:output_type -> tfplugin6.ValidateProviderConfig.Response
	75,  // 171: tfplugin6.Provider.ValidateResourceConfig:output_type -> tfplugin6.ValidateResourceConfig.Response
	77,  // 172: tfplugin6.Provider.ValidateDataResourceConfig:output_type -> tfplugin6.ValidateDataResourceConfig.Response
	73,  // 173: tfplugin6.Provider.UpgradeResourceState:output_type -> tfplugin6.UpgradeResourceState.Response
	110, // 174: tfplugin6.Provider.UpgradeResourceIdentity:output_type -> tfplugin6.UpgradeResourceIdentity.Response
	79,  // 175: tfplugin6.Provider.ConfigureProvider:output_type -> tfplugin6.ConfigureProvider.Response
	81,  // 176: tfplugin6.Provider.ReadResource:output_type -> tfplugin6.ReadResource.Response
	83,  // 177: tfplugin6.Provider.PlanResourceChange:output_type -> tfplugin6.PlanResourceChange.Response
	85,  // 178: tfplugin6.Provider.ApplyResourceChange:output_type -> tfplugin6.ApplyResourceChange.Response
	88,  // 179: tfplugin6.Provider.ImportResourceState:output_type -> tfplugin6.ImportResourceState.Response
	90,  // 180: tfplugin6.Provider.MoveResourceState:output_type -> tfplugin6.MoveResourceState.Response
	92,  // 181: tfplugin6.Provider.ReadDataSource:output_type -> tfplugin6.ReadDataSource.Response
	99,  // 182: tfplugin6.Provider.ValidateEphemeralResourceConfig:output_type -> tfplugin6.ValidateEphemeralResourceConfig.Response
	101, // 183: tfplugin6.Provider.OpenEphemeralResource:output_type -> tfplugin6.OpenEphemeralResource.Response
	103, // 184: tfplugin6.Provider.RenewEphemeralResource:output_type -> tfplugin6.RenewEphemeralResource.Response
	105, // 185: tfplugin6.Provider.CloseEphemeralResource:output_type -> tfplugin6.CloseEphemeralResource.Response
	94,  // 186: tfplugin6.Provider.GetFunctions:output_type -> tfplugin6.GetFunctions.Response
	97,  // 187: tfplugin6.Provider.CallFunction:output_type -> tfplugin6.CallFunction.Response
	112, // 188: tfplugin6.Provider.PlanAction:output_type -> tfplugin6.PlanAction.Response
	115, // 189: tfplugin6.Provider.InvokeAction:output_type -> tfplugin6.InvokeAction.Event
	124, // 190: tfplugin6.Provider.CancelAction:output_type -> tfplugin6.CancelAction.Response
...
func file_tfplugin6_proto_init() {
	...
	file_tfplugin6_proto_msgTypes[38].OneofWrappers = []any{
	...
	file_tfplugin6_proto_msgTypes[96].OneofWrappers = []any{}
