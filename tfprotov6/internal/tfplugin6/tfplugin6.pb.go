...
func (x *RenewEphemeralResource_Request) GetPriorState() *DynamicValue {
	if x != nil {
		return x.PriorState
	}
	return nil
...
type RenewEphemeralResource_Response struct {
	...
	State       *DynamicValue          `protobuf:"bytes,1,opt,name=state,proto3" json:"state,omitempty"`
	Diagnostics []*Diagnostic          `protobuf:"bytes,2,rep,name=diagnostics,proto3" json:"diagnostics,omitempty"`
	RenewAt     *timestamppb.Timestamp `protobuf:"bytes,3,opt,name=renew_at,json=renewAt,proto3,oneof" json:"renew_at,omitempty"`
	Private     []byte                 `protobuf:"bytes,4,opt,name=private,proto3,oneof" json:"private,omitempty"`
}
...
func (x *RenewEphemeralResource_Response) GetState() *DynamicValue {
	if x != nil {
		return x.State
	}
	return nil
...
func (x *CloseEphemeralResource_Request) GetPriorState() *DynamicValue {
	if x != nil {
		return x.PriorState
	}
	return nil
...
var file_tfplugin6_proto_rawDesc = []byte{
	...
	0x69, 0x76, 0x61, 0x74, 0x65, 0x22, 0xc0, 0x03, 0x0a, 0x16, 0x52, 0x65, 0x6e, 0x65, 0x77, 0x45,
	...
	0x6e, 0x66, 0x69, 0x67, 0x12, 0x1d, 0x0a, 0x07, 0x70, 0x72, 0x69, 0x76, 0x61, 0x74, 0x65, 0x18,
	...
	0xe6, 0x01, 0x0a, 0x08, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x2d, 0x0a, 0x05,
	...
	0x5f, 0x70, 0x72, 0x69, 0x76, 0x61, 0x74, 0x65, 0x22, 0xeb, 0x01, 0x0a, 0x16, 0x43, 0x6c, 0x6f,
	0x73, 0x65, 0x45, 0x70, 0x68, 0x65, 0x6d, 0x65, 0x72, 0x61, 0x6c, 0x52, 0x65, 0x73, 0x6f, 0x75,
	0x72, 0x63, 0x65, 0x1a, 0x8b, 0x01, 0x0a, 0x07, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12,
	0x1b, 0x0a, 0x09, 0x74, 0x79, 0x70, 0x65, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01,
	...
	0x72, 0x53, 0x74, 0x61, 0x74, 0x65, 0x12, 0x1d, 0x0a, 0x07, 0x70, 0x72, 0x69, 0x76, 0x61, 0x74,
	0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0c, 0x48, 0x00, 0x52, 0x07, 0x70, 0x72, 0x69, 0x76, 0x61,
	...
	0x0c, 0x0a, 0x08, 0x4d, 0x41, 0x52, 0x4b, 0x44, 0x4f, 0x57, 0x4e, 0x10, 0x01, 0x32, 0x81, 0x10,
	...
	0x75, 0x67, 0x69, 0x6e, 0x36, 0x2e, 0x47, 0x65, 0x74, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74,
	0x61, 0x2e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x60, 0x0a, 0x11, 0x47, 0x65,
	0x74, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x53, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x12,
	0x24, 0x2e, 0x74, 0x66, 0x70, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x36, 0x2e, 0x47, 0x65, 0x74, 0x50,
	...
	0x65, 0x6d, 0x61, 0x2e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x6f, 0x0a, 0x16,
...
var file_tfplugin6_proto_depIdxs = []int32{
	...
	5,   // 99: tfplugin6.RenewEphemeralResource.Request.prior_state:type_name -> tfplugin6.DynamicValue
	5,   // 100: tfplugin6.RenewEphemeralResource.Request.config:type_name -> tfplugin6.DynamicValue
	5,   // 101: tfplugin6.RenewEphemeralResource.Response.state:type_name -> tfplugin6.DynamicValue
	6,   // 102: tfplugin6.RenewEphemeralResource.Response.diagnostics:type_name -> tfplugin6.Diagnostic
	93,  // 103: tfplugin6.RenewEphemeralResource.Response.renew_at:type_name -> google.protobuf.Timestamp
	5,   // 104: tfplugin6.CloseEphemeralResource.Request.prior_state:type_name -> tfplugin6.DynamicValue
	6,   // 105: tfplugin6.CloseEphemeralResource.Response.diagnostics:type_name -> tfplugin6.Diagnostic
	45,  // 106: tfplugin6.Provider.GetMetadata:input_type -> tfplugin6.GetMetadata.Request
	51,  // 107: tfplugin6.Provider.GetProviderSchema:input_type -> tfplugin6.GetProviderSchema.Request
	57,  // 108: tfplugin6.Provider.ValidateProviderConfig:input_type -> tfplugin6.ValidateProviderConfig.Request
	61,  // 109: tfplugin6.Provider.ValidateResourceConfig:input_type -> tfplugin6.ValidateResourceConfig.Request
	63,  // 110: tfplugin6.Provider.ValidateDataResourceConfig:input_type -> tfplugin6.ValidateDataResourceConfig.Request
	59,  // 111: tfplugin6.Provider.UpgradeResourceState:input_type -> tfplugin6.UpgradeResourceState.Request
	65,  // 112: tfplugin6.Provider.ConfigureProvider:input_type -> tfplugin6.ConfigureProvider.Request
	67,  // 113: tfplugin6.Provider.ReadResource:input_type -> tfplugin6.ReadResource.Request
	69,  // 114: tfplugin6.Provider.PlanResourceChange:input_type -> tfplugin6.PlanResourceChange.Request
	71,  // 115: tfplugin6.Provider.ApplyResourceChange:input_type -> tfplugin6.ApplyResourceChange.Request
	73,  // 116: tfplugin6.Provider.ImportResourceState:input_type -> tfplugin6.ImportResourceState.Request
	76,  // 117: tfplugin6.Provider.MoveResourceState:input_type -> tfplugin6.MoveResourceState.Request
	78,  // 118: tfplugin6.Provider.ReadDataSource:input_type -> tfplugin6.ReadDataSource.Request
	85,  // 119: tfplugin6.Provider.ValidateEphemeralResourceConfig:input_type -> tfplugin6.ValidateEphemeralResourceConfig.Request
	87,  // 120: tfplugin6.Provider.OpenEphemeralResource:input_type -> tfplugin6.OpenEphemeralResource.Request
	89,  // 121: tfplugin6.Provider.RenewEphemeralResource:input_type -> tfplugin6.RenewEphemeralResource.Request
	91,  // 122: tfplugin6.Provider.CloseEphemeralResource:input_type -> tfplugin6.CloseEphemeralResource.Request
	80,  // 123: tfplugin6.Provider.GetFunctions:input_type -> tfplugin6.GetFunctions.Request
	83,  // 124: tfplugin6.Provider.CallFunction:input_type -> tfplugin6.CallFunction.Request
	36,  // 125: tfplugin6.Provider.StopProvider:input_type -> tfplugin6.StopProvider.Request
	46,  // 126: tfplugin6.Provider.GetMetadata:output_type -> tfplugin6.GetMetadata.Response
	52,  // 127: tfplugin6.Provider.GetProviderSchema:output_type -> tfplugin6.GetProviderSchema.Response
	58,  // 128: tfplugin6.Provider.ValidateProviderConfig:output_type -> tfplugin6.ValidateProviderConfig.Response
	62,  // 129: tfplugin6.Provider.ValidateResourceConfig:output_type -> tfplugin6.ValidateResourceConfig.Response
	64,  // 130: tfplugin6.Provider.ValidateDataResourceConfig:output_type -> tfplugin6.ValidateDataResourceConfig.Response
	60,  // 131: tfplugin6.Provider.UpgradeResourceState:output_type -> tfplugin6.UpgradeResourceState.Response
	66,  // 132: tfplugin6.Provider.ConfigureProvider:output_type -> tfplugin6.ConfigureProvider.Response
	68,  // 133: tfplugin6.Provider.ReadResource:output_type -> tfplugin6.ReadResource.Response
	70,  // 134: tfplugin6.Provider.PlanResourceChange:output_type -> tfplugin6.PlanResourceChange.Response
	72,  // 135: tfplugin6.Provider.ApplyResourceChange:output_type -> tfplugin6.ApplyResourceChange.Response
	75,  // 136: tfplugin6.Provider.ImportResourceState:output_type -> tfplugin6.ImportResourceState.Response
	77,  // 137: tfplugin6.Provider.MoveResourceState:output_type -> tfplugin6.MoveResourceState.Response
	79,  // 138: tfplugin6.Provider.ReadDataSource:output_type -> tfplugin6.ReadDataSource.Response
	86,  // 139: tfplugin6.Provider.ValidateEphemeralResourceConfig:output_type -> tfplugin6.ValidateEphemeralResourceConfig.Response
	88,  // 140: tfplugin6.Provider.OpenEphemeralResource:output_type -> tfplugin6.OpenEphemeralResource.Response
	90,  // 141: tfplugin6.Provider.RenewEphemeralResource:output_type -> tfplugin6.RenewEphemeralResource.Response
	92,  // 142: tfplugin6.Provider.CloseEphemeralResource:output_type -> tfplugin6.CloseEphemeralResource.Response
	81,  // 143: tfplugin6.Provider.GetFunctions:output_type -> tfplugin6.GetFunctions.Response
	84,  // 144: tfplugin6.Provider.CallFunction:output_type -> tfplugin6.CallFunction.Response
	37,  // 145: tfplugin6.Provider.StopProvider:output_type -> tfplugin6.StopProvider.Response
	126, // [126:146] is the sub-list for method output_type
	106, // [106:126] is the sub-list for method input_type
