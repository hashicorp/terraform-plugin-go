...
type Schema struct {
	...
	// the behavior of individual resources. This is used to indicate
	// forward-compatible changes which cannot be directly tested by the plugin
	// client, allowing protocol5 resources to be muxed with strict protocol6
	// resources from the same provider.
	Capabilities *Schema_Capabilities `protobuf:"bytes,3,opt,name=capabilities,proto3" json:"capabilities,omitempty"`
}
...
func (x *Schema) GetCapabilities() *Schema_Capabilities {
	if x != nil {
...
type Schema_Capabilities struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// Enable the use of nested object types, implicitly disabling the use
	// of blocks-as-attributes.
	StructuralAttrs bool `protobuf:"varint,1,opt,name=structural_attrs,json=structuralAttrs,proto3" json:"structural_attrs,omitempty"`
}

func (x *Schema_Capabilities) Reset() {
	*x = Schema_Capabilities{}
	if protoimpl.UnsafeEnabled {
...
func (x *Schema_Capabilities) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Schema_Capabilities) ProtoMessage() {}

func (x *Schema_Capabilities) ProtoReflect() protoreflect.Message {
	mi := &file_tfplugin6_proto_msgTypes[25]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Schema_Capabilities.ProtoReflect.Descriptor instead.
func (*Schema_Capabilities) Descriptor() ([]byte, []int) {
	return file_tfplugin6_proto_rawDescGZIP(), []int{5, 4}
}

func (x *Schema_Capabilities) GetStructuralAttrs() bool {
	if x != nil {
		return x.StructuralAttrs
	}
	return false
}
...
var file_tfplugin6_proto_rawDesc = []byte{
	...
	0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x8c, 0x0b, 0x0a, 0x06, 0x53, 0x63, 0x68, 0x65, 0x6d, 0x61,
	...
	0x63, 0x6b, 0x52, 0x05, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x12, 0x42, 0x0a, 0x0c, 0x63, 0x61, 0x70,
	0x61, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x69, 0x65, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32,
	0x1e, 0x2e, 0x74, 0x66, 0x70, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x36, 0x2e, 0x53, 0x63, 0x68, 0x65,
	0x6d, 0x61, 0x2e, 0x43, 0x61, 0x70, 0x61, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x69, 0x65, 0x73, 0x52,
	0x0c, 0x63, 0x61, 0x70, 0x61, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x69, 0x65, 0x73, 0x1a, 0xa2, 0x02,
	...
	0x50, 0x10, 0x05, 0x1a, 0x83, 0x02, 0x0a, 0x06, 0x4f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x12, 0x3b,
	...
	0x49, 0x74, 0x65, 0x6d, 0x73, 0x22, 0x42, 0x0a, 0x0b, 0x4e, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x67,
	...
	0x69, 0x6e, 0x36, 0x2e, 0x44, 0x79, 0x6e, 0x61, 0x6d, 0x69, 0x63, 0x56, 0x61, 0x6c, 0x75, 0x65,
	0x52, 0x0c, 0x70, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x4d, 0x65, 0x74, 0x61, 0x1a, 0x93,
	...
	0x74, 0x69, 0x63, 0x73, 0x22, 0xed, 0x02, 0x0a, 0x13, 0x49, 0x6d, 0x70, 0x6f, 0x72, 0x74, 0x52,
...
var file_tfplugin6_proto_goTypes = []interface{}{
	...
	(*Schema_Capabilities)(nil),                  // 29: tfplugin6.Schema.Capabilities
	(*GetProviderSchema_Request)(nil),            // 30: tfplugin6.GetProviderSchema.Request
	(*GetProviderSchema_Response)(nil),           // 31: tfplugin6.GetProviderSchema.Response
...
var file_tfplugin6_proto_depIdxs = []int32{
	...
	29, // 5: tfplugin6.Schema.capabilities:type_name -> tfplugin6.Schema.Capabilities
	26, // 6: tfplugin6.Schema.Block.attributes:type_name -> tfplugin6.Schema.Attribute
	27, // 7: tfplugin6.Schema.Block.block_types:type_name -> tfplugin6.Schema.NestedBlock
	0,  // 8: tfplugin6.Schema.Block.description_kind:type_name -> tfplugin6.StringKind
	28, // 9: tfplugin6.Schema.Attribute.nested_type:type_name -> tfplugin6.Schema.Object
	0,  // 10: tfplugin6.Schema.Attribute.description_kind:type_name -> tfplugin6.StringKind
	25, // 11: tfplugin6.Schema.NestedBlock.block:type_name -> tfplugin6.Schema.Block
	2,  // 12: tfplugin6.Schema.NestedBlock.nesting:type_name -> tfplugin6.Schema.NestedBlock.NestingMode
	26, // 13: tfplugin6.Schema.Object.attributes:type_name -> tfplugin6.Schema.Attribute
	3,  // 14: tfplugin6.Schema.Object.nesting:type_name -> tfplugin6.Schema.Object.NestingMode
	9,  // 15: tfplugin6.GetProviderSchema.Response.provider:type_name -> tfplugin6.Schema
	32, // 16: tfplugin6.GetProviderSchema.Response.resource_schemas:type_name -> tfplugin6.GetProviderSchema.Response.ResourceSchemasEntry
	33, // 17: tfplugin6.GetProviderSchema.Response.data_source_schemas:type_name -> tfplugin6.GetProviderSchema.Response.DataSourceSchemasEntry
	5,  // 18: tfplugin6.GetProviderSchema.Response.diagnostics:type_name -> tfplugin6.Diagnostic
	9,  // 19: tfplugin6.GetProviderSchema.Response.provider_meta:type_name -> tfplugin6.Schema
	...
	30, // 57: tfplugin6.Provider.GetProviderSchema:input_type -> tfplugin6.GetProviderSchema.Request
	...
	31, // 69: tfplugin6.Provider.GetProviderSchema:output_type -> tfplugin6.GetProviderSchema.Response
...
func file_tfplugin6_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_tfplugin6_proto_msgTypes[25].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Schema_Capabilities); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
