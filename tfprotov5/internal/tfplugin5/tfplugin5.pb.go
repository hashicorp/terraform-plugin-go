...
const file_tfplugin5_proto_rawDesc = "" +
	...
	"\x15list_resource_schemas\x18\t \x03(\v2>.tfplugin5.GetProviderSchema.Response.ListResourceSchemasEntryR\x13listResourceSchemas\x1aU\n" +
