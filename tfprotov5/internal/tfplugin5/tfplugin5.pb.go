...
var file_tfplugin5_proto_rawDesc = []byte{
	...
	0x52, 0x4b, 0x44, 0x4f, 0x57, 0x4e, 0x10, 0x01, 0x32, 0xcc, 0x0f, 0x0a, 0x08, 0x50, 0x72, 0x6f,
	...
	0x61, 0x74, 0x65, 0x2e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x48, 0x0a, 0x09,
...
var file_tfplugin5_proto_depIdxs = []int32{
	...
	4,   // 104: tfplugin5.RenewEphemeralResource.Request.state:type_name -> tfplugin5.DynamicValue
	4,   // 105: tfplugin5.RenewEphemeralResource.Request.config:type_name -> tfplugin5.DynamicValue
	5,   // 106: tfplugin5.RenewEphemeralResource.Response.diagnostics:type_name -> tfplugin5.Diagnostic
	100, // 107: tfplugin5.RenewEphemeralResource.Response.renew_at:type_name -> google.protobuf.Timestamp
	4,   // 108: tfplugin5.CloseEphemeralResource.Request.state:type_name -> tfplugin5.DynamicValue
	5,   // 109: tfplugin5.CloseEphemeralResource.Response.diagnostics:type_name -> tfplugin5.Diagnostic
	46,  // 110: tfplugin5.Provider.GetMetadata:input_type -> tfplugin5.GetMetadata.Request
	52,  // 111: tfplugin5.Provider.GetSchema:input_type -> tfplugin5.GetProviderSchema.Request
	58,  // 112: tfplugin5.Provider.PrepareProviderConfig:input_type -> tfplugin5.PrepareProviderConfig.Request
	62,  // 113: tfplugin5.Provider.ValidateResourceTypeConfig:input_type -> tfplugin5.ValidateResourceTypeConfig.Request
	64,  // 114: tfplugin5.Provider.ValidateDataSourceConfig:input_type -> tfplugin5.ValidateDataSourceConfig.Request
	60,  // 115: tfplugin5.Provider.UpgradeResourceState:input_type -> tfplugin5.UpgradeResourceState.Request
	66,  // 116: tfplugin5.Provider.Configure:input_type -> tfplugin5.Configure.Request
	68,  // 117: tfplugin5.Provider.ReadResource:input_type -> tfplugin5.ReadResource.Request
	70,  // 118: tfplugin5.Provider.PlanResourceChange:input_type -> tfplugin5.PlanResourceChange.Request
	72,  // 119: tfplugin5.Provider.ApplyResourceChange:input_type -> tfplugin5.ApplyResourceChange.Request
	74,  // 120: tfplugin5.Provider.ImportResourceState:input_type -> tfplugin5.ImportResourceState.Request
	77,  // 121: tfplugin5.Provider.MoveResourceState:input_type -> tfplugin5.MoveResourceState.Request
	79,  // 122: tfplugin5.Provider.ReadDataSource:input_type -> tfplugin5.ReadDataSource.Request
	92,  // 123: tfplugin5.Provider.ValidateEphemeralResourceConfig:input_type -> tfplugin5.ValidateEphemeralResourceConfig.Request
	94,  // 124: tfplugin5.Provider.OpenEphemeralResource:input_type -> tfplugin5.OpenEphemeralResource.Request
	96,  // 125: tfplugin5.Provider.RenewEphemeralResource:input_type -> tfplugin5.RenewEphemeralResource.Request
	98,  // 126: tfplugin5.Provider.CloseEphemeralResource:input_type -> tfplugin5.CloseEphemeralResource.Request
	87,  // 127: tfplugin5.Provider.GetFunctions:input_type -> tfplugin5.GetFunctions.Request
	90,  // 128: tfplugin5.Provider.CallFunction:input_type -> tfplugin5.CallFunction.Request
	38,  // 129: tfplugin5.Provider.Stop:input_type -> tfplugin5.Stop.Request
	81,  // 130: tfplugin5.Provisioner.GetSchema:input_type -> tfplugin5.GetProvisionerSchema.Request
	83,  // 131: tfplugin5.Provisioner.ValidateProvisionerConfig:input_type -> tfplugin5.ValidateProvisionerConfig.Request
	85,  // 132: tfplugin5.Provisioner.ProvisionResource:input_type -> tfplugin5.ProvisionResource.Request
	38,  // 133: tfplugin5.Provisioner.Stop:input_type -> tfplugin5.Stop.Request
	47,  // 134: tfplugin5.Provider.GetMetadata:output_type -> tfplugin5.GetMetadata.Response
	53,  // 135: tfplugin5.Provider.GetSchema:output_type -> tfplugin5.GetProviderSchema.Response
	59,  // 136: tfplugin5.Provider.PrepareProviderConfig:output_type -> tfplugin5.PrepareProviderConfig.Response
	63,  // 137: tfplugin5.Provider.ValidateResourceTypeConfig:output_type -> tfplugin5.ValidateResourceTypeConfig.Response
	65,  // 138: tfplugin5.Provider.ValidateDataSourceConfig:output_type -> tfplugin5.ValidateDataSourceConfig.Response
	61,  // 139: tfplugin5.Provider.UpgradeResourceState:output_type -> tfplugin5.UpgradeResourceState.Response
	67,  // 140: tfplugin5.Provider.Configure:output_type -> tfplugin5.Configure.Response
	69,  // 141: tfplugin5.Provider.ReadResource:output_type -> tfplugin5.ReadResource.Response
	71,  // 142: tfplugin5.Provider.PlanResourceChange:output_type -> tfplugin5.PlanResourceChange.Response
	73,  // 143: tfplugin5.Provider.ApplyResourceChange:output_type -> tfplugin5.ApplyResourceChange.Response
	76,  // 144: tfplugin5.Provider.ImportResourceState:output_type -> tfplugin5.ImportResourceState.Response
	78,  // 145: tfplugin5.Provider.MoveResourceState:output_type -> tfplugin5.MoveResourceState.Response
	80,  // 146: tfplugin5.Provider.ReadDataSource:output_type -> tfplugin5.ReadDataSource.Response
	93,  // 147: tfplugin5.Provider.ValidateEphemeralResourceConfig:output_type -> tfplugin5.ValidateEphemeralResourceConfig.Response
	95,  // 148: tfplugin5.Provider.OpenEphemeralResource:output_type -> tfplugin5.OpenEphemeralResource.Response
	97,  // 149: tfplugin5.Provider.RenewEphemeralResource:output_type -> tfplugin5.RenewEphemeralResource.Response
	99,  // 150: tfplugin5.Provider.CloseEphemeralResource:output_type -> tfplugin5.CloseEphemeralResource.Response
	88,  // 151: tfplugin5.Provider.GetFunctions:output_type -> tfplugin5.GetFunctions.Response
	91,  // 152: tfplugin5.Provider.CallFunction:output_type -> tfplugin5.CallFunction.Response
	39,  // 153: tfplugin5.Provider.Stop:output_type -> tfplugin5.Stop.Response
	82,  // 154: tfplugin5.Provisioner.GetSchema:output_type -> tfplugin5.GetProvisionerSchema.Response
	84,  // 155: tfplugin5.Provisioner.ValidateProvisionerConfig:output_type -> tfplugin5.ValidateProvisionerConfig.Response
	86,  // 156: tfplugin5.Provisioner.ProvisionResource:output_type -> tfplugin5.ProvisionResource.Response
	39,  // 157: tfplugin5.Provisioner.Stop:output_type -> tfplugin5.Stop.Response
	134, // [134:158] is the sub-list for method output_type
	110, // [110:134] is the sub-list for method input_type
