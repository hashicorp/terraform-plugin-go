...
var file_tfplugin5_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x76, 0x35, 0x2f, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c,
...
var file_tfplugin5_proto_depIdxs = []int32{
	...
	5,   // 99: tfplugin5.OpenEphemeralResource.Response.diagnostics:type_name -> tfplugin5.Diagnostic
	100, // 100: tfplugin5.OpenEphemeralResource.Response.renew_at:type_name -> google.protobuf.Timestamp
	4,   // 101: tfplugin5.OpenEphemeralResource.Response.state:type_name -> tfplugin5.DynamicValue
	4,   // 102: tfplugin5.RenewEphemeralResource.Request.prior_state:type_name -> tfplugin5.DynamicValue
	4,   // 103: tfplugin5.RenewEphemeralResource.Request.config:type_name -> tfplugin5.DynamicValue
	4,   // 104: tfplugin5.RenewEphemeralResource.Response.state:type_name -> tfplugin5.DynamicValue
	...
	4,   // 107: tfplugin5.CloseEphemeralResource.Request.prior_state:type_name -> tfplugin5.DynamicValue
