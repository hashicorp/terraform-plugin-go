...
var file_tfplugin5_proto_rawDesc = []byte{
	...
	0x65, 0x66, 0x65, 0x72, 0x72, 0x65, 0x64, 0x22, 0xe2, 0x04, 0x0a, 0x13, 0x41, 0x70, 0x70, 0x6c,
	0x79, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x1a,
	0x86, 0x03, 0x0a, 0x07, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1b, 0x0a, 0x09, 0x74,
	...
	0x62, 0x69, 0x6c, 0x69, 0x74, 0x69, 0x65, 0x73, 0x1a, 0xc1, 0x01, 0x0a, 0x08, 0x52, 0x65, 0x73,
	...
	0x0c, 0x0a, 0x08, 0x4d, 0x41, 0x52, 0x4b, 0x44, 0x4f, 0x57, 0x4e, 0x10, 0x01, 0x32, 0xcc, 0x0f,
...
var file_tfplugin5_proto_depIdxs = []int32{
	...
	12,  // 68: tfplugin5.ApplyResourceChange.Request.client_capabilities:type_name -> tfplugin5.ClientCapabilities
	...
	75,  // 73: tfplugin5.ImportResourceState.Response.imported_resources:type_name -> tfplugin5.ImportResourceState.ImportedResource
	...
	89,  // 92: tfplugin5.GetFunctions.Response.functions:type_name -> tfplugin5.GetFunctions.Response.FunctionsEntry
	5,   // 93: tfplugin5.GetFunctions.Response.diagnostics:type_name -> tfplugin5.Diagnostic
	13,  // 94: tfplugin5.GetFunctions.Response.FunctionsEntry.value:type_name -> tfplugin5.Function
	4,   // 95: tfplugin5.CallFunction.Request.arguments:type_name -> tfplugin5.DynamicValue
	4,   // 96: tfplugin5.CallFunction.Response.result:type_name -> tfplugin5.DynamicValue
	6,   // 97: tfplugin5.CallFunction.Response.error:type_name -> tfplugin5.FunctionError
	4,   // 98: tfplugin5.ValidateEphemeralResourceConfig.Request.config:type_name -> tfplugin5.DynamicValue
	5,   // 99: tfplugin5.ValidateEphemeralResourceConfig.Response.diagnostics:type_name -> tfplugin5.Diagnostic
	4,   // 100: tfplugin5.OpenEphemeralResource.Request.config:type_name -> tfplugin5.DynamicValue
	...
	4,   // 103: tfplugin5.OpenEphemeralResource.Response.state:type_name -> tfplugin5.DynamicValue
	4,   // 104: tfplugin5.RenewEphemeralResource.Request.prior_state:type_name -> tfplugin5.DynamicValue
	4,   // 105: tfplugin5.RenewEphemeralResource.Request.config:type_name -> tfplugin5.DynamicValue
	4,   // 106: tfplugin5.RenewEphemeralResource.Response.state:type_name -> tfplugin5.DynamicValue
	5,   // 107: tfplugin5.RenewEphemeralResource.Response.diagnostics:type_name -> tfplugin5.Diagnostic
	100, // 108: tfplugin5.RenewEphemeralResource.Response.renew_at:type_name -> google.protobuf.Timestamp
	4,   // 109: tfplugin5.CloseEphemeralResource.Request.prior_state:type_name -> tfplugin5.DynamicValue
	5,   // 110: tfplugin5.CloseEphemeralResource.Response.diagnostics:type_name -> tfplugin5.Diagnostic
	46,  // 111: tfplugin5.Provider.GetMetadata:input_type -> tfplugin5.GetMetadata.Request
	52,  // 112: tfplugin5.Provider.GetSchema:input_type -> tfplugin5.GetProviderSchema.Request
	58,  // 113: tfplugin5.Provider.PrepareProviderConfig:input_type -> tfplugin5.PrepareProviderConfig.Request
	62,  // 114: tfplugin5.Provider.ValidateResourceTypeConfig:input_type -> tfplugin5.ValidateResourceTypeConfig.Request
	64,  // 115: tfplugin5.Provider.ValidateDataSourceConfig:input_type -> tfplugin5.ValidateDataSourceConfig.Request
	60,  // 116: tfplugin5.Provider.UpgradeResourceState:input_type -> tfplugin5.UpgradeResourceState.Request
	66,  // 117: tfplugin5.Provider.Configure:input_type -> tfplugin5.Configure.Request
	68,  // 118: tfplugin5.Provider.ReadResource:input_type -> tfplugin5.ReadResource.Request
	70,  // 119: tfplugin5.Provider.PlanResourceChange:input_type -> tfplugin5.PlanResourceChange.Request
	72,  // 120: tfplugin5.Provider.ApplyResourceChange:input_type -> tfplugin5.ApplyResourceChange.Request
	74,  // 121: tfplugin5.Provider.ImportResourceState:input_type -> tfplugin5.ImportResourceState.Request
	77,  // 122: tfplugin5.Provider.MoveResourceState:input_type -> tfplugin5.MoveResourceState.Request
	79,  // 123: tfplugin5.Provider.ReadDataSource:input_type -> tfplugin5.ReadDataSource.Request
	92,  // 124: tfplugin5.Provider.ValidateEphemeralResourceConfig:input_type -> tfplugin5.ValidateEphemeralResourceConfig.Request
	94,  // 125: tfplugin5.Provider.OpenEphemeralResource:input_type -> tfplugin5.OpenEphemeralResource.Request
	96,  // 126: tfplugin5.Provider.RenewEphemeralResource:input_type -> tfplugin5.RenewEphemeralResource.Request
	98,  // 127: tfplugin5.Provider.CloseEphemeralResource:input_type -> tfplugin5.CloseEphemeralResource.Request
	87,  // 128: tfplugin5.Provider.GetFunctions:input_type -> tfplugin5.GetFunctions.Request
	90,  // 129: tfplugin5.Provider.CallFunction:input_type -> tfplugin5.CallFunction.Request
	38,  // 130: tfplugin5.Provider.Stop:input_type -> tfplugin5.Stop.Request
	81,  // 131: tfplugin5.Provisioner.GetSchema:input_type -> tfplugin5.GetProvisionerSchema.Request
	83,  // 132: tfplugin5.Provisioner.ValidateProvisionerConfig:input_type -> tfplugin5.ValidateProvisionerConfig.Request
	85,  // 133: tfplugin5.Provisioner.ProvisionResource:input_type -> tfplugin5.ProvisionResource.Request
	38,  // 134: tfplugin5.Provisioner.Stop:input_type -> tfplugin5.Stop.Request
	47,  // 135: tfplugin5.Provider.GetMetadata:output_type -> tfplugin5.GetMetadata.Response
	53,  // 136: tfplugin5.Provider.GetSchema:output_type -> tfplugin5.GetProviderSchema.Response
	59,  // 137: tfplugin5.Provider.PrepareProviderConfig:output_type -> tfplugin5.PrepareProviderConfig.Response
	63,  // 138: tfplugin5.Provider.ValidateResourceTypeConfig:output_type -> tfplugin5.ValidateResourceTypeConfig.Response
	65,  // 139: tfplugin5.Provider.ValidateDataSourceConfig:output_type -> tfplugin5.ValidateDataSourceConfig.Response
	61,  // 140: tfplugin5.Provider.UpgradeResourceState:output_type -> tfplugin5.UpgradeResourceState.Response
	67,  // 141: tfplugin5.Provider.Configure:output_type -> tfplugin5.Configure.Response
	69,  // 142: tfplugin5.Provider.ReadResource:output_type -> tfplugin5.ReadResource.Response
	71,  // 143: tfplugin5.Provider.PlanResourceChange:output_type -> tfplugin5.PlanResourceChange.Response
	73,  // 144: tfplugin5.Provider.ApplyResourceChange:output_type -> tfplugin5.ApplyResourceChange.Response
	76,  // 145: tfplugin5.Provider.ImportResourceState:output_type -> tfplugin5.ImportResourceState.Response
	78,  // 146: tfplugin5.Provider.MoveResourceState:output_type -> tfplugin5.MoveResourceState.Response
	80,  // 147: tfplugin5.Provider.ReadDataSource:output_type -> tfplugin5.ReadDataSource.Response
	93,  // 148: tfplugin5.Provider.ValidateEphemeralResourceConfig:output_type -> tfplugin5.ValidateEphemeralResourceConfig.Response
	95,  // 149: tfplugin5.Provider.OpenEphemeralResource:output_type -> tfplugin5.OpenEphemeralResource.Response
	97,  // 150: tfplugin5.Provider.RenewEphemeralResource:output_type -> tfplugin5.RenewEphemeralResource.Response
	99,  // 151: tfplugin5.Provider.CloseEphemeralResource:output_type -> tfplugin5.CloseEphemeralResource.Response
	88,  // 152: tfplugin5.Provider.GetFunctions:output_type -> tfplugin5.GetFunctions.Response
	91,  // 153: tfplugin5.Provider.CallFunction:output_type -> tfplugin5.CallFunction.Response
	39,  // 154: tfplugin5.Provider.Stop:output_type -> tfplugin5.Stop.Response
	82,  // 155: tfplugin5.Provisioner.GetSchema:output_type -> tfplugin5.GetProvisionerSchema.Response
	84,  // 156: tfplugin5.Provisioner.ValidateProvisionerConfig:output_type -> tfplugin5.ValidateProvisionerConfig.Response
	86,  // 157: tfplugin5.Provisioner.ProvisionResource:output_type -> tfplugin5.ProvisionResource.Response
	39,  // 158: tfplugin5.Provisioner.Stop:output_type -> tfplugin5.Stop.Response
	135, // [135:159] is the sub-list for method output_type
	111, // [111:135] is the sub-list for method input_type
