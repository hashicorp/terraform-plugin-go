...
func TestMsgPackMarshalValue(t *testing.T) {
	t.Parallel()
	...
	tests := map[string]testCase{
		...
		"list-string-empty": {
			hex:   "90",
			value: NewValue(List{ElementType: String}, []Value{}),
			typ:   List{ElementType: String},
		},
		"set-string-hello": {
			hex:   "91a568656c6c6f",
		...
		"set-string-null-string": {
			hex:   "91c0",
			value: NewValue(Set{ElementType: String}, []Value{NewValue(String, nil)}),
			typ:   Set{ElementType: String},
		},
		"set-string-empty": {
			hex:   "90",
			value: NewValue(Set{ElementType: String}, []Value{}),
			typ:   Set{ElementType: String},
		},
		"map-string-hello": {
			hex: "81a86772656574696e67a568656c6c6f",
			value: NewValue(Map{AttributeType: String}, map[string]Value{
		...
		"tuple-string-hello": {
			hex:   "91a568656c6c6f",
			value: NewValue(Tuple{ElementTypes: []Type{String}}, []Value{NewValue(String, "hello")}),
			typ:   Tuple{ElementTypes: []Type{String}},
		},
		"tuple-string-unknown": {
			hex:   "91d40000",
			value: NewValue(Tuple{ElementTypes: []Type{String}}, []Value{NewValue(String, UnknownValue)}),
			typ:   Tuple{ElementTypes: []Type{String}},
		},
		"tuple-string-null": {
			hex:   "91c0",
			value: NewValue(Tuple{ElementTypes: []Type{String}}, []Value{NewValue(String, nil)}),
			typ:   Tuple{ElementTypes: []Type{String}},
		},
		"tuple-empty": {
			hex:   "90",
			value: NewValue(Tuple{ElementTypes: []Type{}}, []Value{}),
		...
		"object-empty": {
			hex:   "80",
			value: NewValue(Object{AttributeTypes: map[string]Type{}}, map[string]Value{}),
			typ:   Object{AttributeTypes: map[string]Type{}},
		},
		"string-dynamic-null": {
